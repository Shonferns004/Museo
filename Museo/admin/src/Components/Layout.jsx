...
import { Home, Landmark, ChevronLeft, ChevronRight, Columns } from 'lucide-react';
import Navbar from './Navbar';
import { useAuth } from '../context/AuthContext';

const sidebarLinks = [
  { icon: Home, label: 'Dashboard', path: '/home' },
  { icon: Landmark, label: 'Add Monuments', path: '/add' },
  { icon: Columns, label: 'Monuments', path: '/view' },
];
